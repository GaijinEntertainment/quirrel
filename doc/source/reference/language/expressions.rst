...
Note: 'key' should not be separated with space[s] or new line from '?.' or '.'

^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
.$ and ?.$ - Delegate loading operator
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
Note: 'key' should not be separated with space[s] or new line from '.$' and '?.$'
