...
// TODO: unify this with sqast_dump.h
...
class RenderVisitor : public Visitor {
    ...
    const char* treeopToStr(enum TreeOp op) {
        ...
        case TO_STATIC_MEMO: return "STATIC ";
        case TO_INLINE_CONST: return "CONST ";
...
public:
    ...
    virtual void visitId(Id *id) { _out->writeString(id->name()); }
